using Microservice.RabbitMQMessageBrokerExtension.Builder;
using Microservice.RabbitMQMessageBrokerExtension.Configuration;
using Microservice.RabbitMQMessageBrokerExtension.Extensions;
    ...
    public class RabbitMessageBrokerClient : IRabbitMessageBrokerClient
    {
            ...
            Func<MessageBrokerConfigBuilder, MessageBrokerConfigBuilder> config = null)
        {
            ...
            consumer.Received += (model, basicAckEventArgs) =>
            {
                ...
                sw.Start();
                var body = Encoding.UTF8.GetString(basicAckEventArgs.Body.ToArray());
